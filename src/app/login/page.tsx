    ...
    return (
        <main className='w-screen h-screen flex items-center justify-center'>
            <div className='p-6 gap-2 rounded-sm shadow-md border grid bg-gray-300'>
                ...
                <button className=' w-full p-2 rounded-sm border-purple-900 border text-purple-500 font-bold'> Login </button>
                <p> Don't have account?<span className=' text-purple-600 font-bold'> <Link href={'/signup'}> Register </Link></span> </p>
            </div>
        </main>
    )
}
